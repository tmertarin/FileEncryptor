namespace FileEncryptor
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            txtFilePath.ReadOnly = true; // 🔐 Manuel edit kapalı
            ...
            txtPassword.ShortcutsEnabled = false;               // 🔐 Kopyalama kapalı
            txtPassword.ContextMenuStrip = new ContextMenuStrip(); // 🔐 Sağ tık menüsü yok
            txtPassword.ImeMode = ImeMode.Disable;              // 🔐 IME kapalı
